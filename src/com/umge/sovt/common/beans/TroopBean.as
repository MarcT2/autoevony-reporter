package com.umge.sovt.common.beans
{
    ...
    public class TroopBean extends Object implements IEventDispatcher
    {
		...
		public function toString() : String
		{
			...
			if (this.archer > 0) 		response += "archer:" + this.archer + " ";
			if (this.ballista > 0) 		response += "ballista:" + this.ballista + " ";
			if (this.batteringRam > 0)	response += "battering ram:" + this.batteringRam + " ";
			if (this.carriage > 0) 		response += "transport:" + this.carriage + " ";
			if (this.catapult > 0) 		response += "catapult:" + this.catapult + " ";
			if (this.heavyCavalry > 0)	response += "cataphract:" + this.heavyCavalry + " ";
			if (this.lightCavalry > 0)	response += "cavalry:" + this.lightCavalry + " ";
			if (this.militia > 0)		response += "warrior:" + this.militia + " ";
			if (this.peasants > 0)		response += "worker:" + this.peasants + " ";
			if (this.pikemen > 0)		response += "pikemen:" + this.pikemen + " ";
			if (this.scouter > 0)		response += "scout:" + this.scouter + " ";
			if (this.swordsmen > 0)		response += "swordmen:" + this.swordsmen + " ";
