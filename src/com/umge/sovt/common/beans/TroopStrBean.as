package com.umge.sovt.common.beans
{
    ...
    public class TroopStrBean extends Object implements IEventDispatcher
    {
        ...
        public function get batteringRam() : String
        {
      	...
      	/**
		 * Outputs a usable string of the troop levels in a TroopBean
		 */
		public function toString() : String
		{
			var response:String = "";

			if (this.archer != null && int(this.archer) > 0) 		response += "archer:" + this.archer + " ";
			if (this.ballista != null && int(this.ballista) > 0) 		response += "ballista:" + this.ballista + " ";
			if (this.batteringRam != null && int(this.batteringRam) > 0)	response += "battering ram:" + this.batteringRam + " ";
			if (this.carriage != null && int(this.carriage) > 0) 		response += "transport:" + this.carriage + " ";
			if (this.catapult != null && int(this.catapult) > 0) 		response += "catapult:" + this.catapult + " ";
			if (this.heavyCavalry != null && int(this.heavyCavalry) > 0)	response += "cataphract:" + this.heavyCavalry + " ";
			if (this.lightCavalry != null && int(this.lightCavalry) > 0)	response += "cavalry:" + this.lightCavalry + " ";
			if (this.militia != null && int(this.militia) > 0)		response += "warrior:" + this.militia + " ";
			if (this.peasants != null && int(this.peasants) > 0)		response += "worker:" + this.peasants + " ";
			if (this.pikemen != null && int(this.pikemen) > 0)		response += "pikemen:" + this.pikemen + " ";
			if (this.scouter != null && int(this.scouter) > 0)		response += "scout:" + this.scouter + " ";
			if (this.swordsmen != null && int(this.swordsmen) > 0)		response += "swordmen:" + this.swordsmen + " ";
